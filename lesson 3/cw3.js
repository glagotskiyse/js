...
/*let simpsons = [
    {
        ...
        surname: 'Simpson',
        age: 10,
        info: 'Бартоломб\`ю ДжоДжо «Барт» Сімпсон (англ. Bartholomew JoJo «Bart» Simpson) — один із головних героїв мультиплікаційного серіалу Сімпсони. Барт — найстарша дитина Гомера і Мардж Сімпсон. У нього також є дві молодші сестри — Ліса і Меґґі. Барт є втіленням образу бешкетника та посереднього учня у школі. Разом зі своїм батьком Барт є одним із найвідоміших персонажів у цьому серіалі.',
...
//             2.1
/*for (let simpsonsKey of simpsons) {
    document.write(`<div>${simpsonsKey.name}-
${simpsonsKey.surname}-
${simpsonsKey.age}-
${simpsonsKey.info}-
<img src="${simpsonsKey.photo}" alt="">
</div>`);
}*/
...
/*for (let simpson of simpsons) {
    ...
    document.write(`<img src="${simpson.photo}" alt="simpsons">`)
    document.write(`</div>`)
}*/
